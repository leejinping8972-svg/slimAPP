...
function SuccessContent() {
    ...
    const [orderId] = useState(() => Math.floor(Math.random() * 1000000).toString().padStart(6, '0'));
    ...
    return (
        <div className="min-h-screen bg-[#F7F5F1] noise-overlay flex flex-col">
            ...
            <main className="flex-grow flex items-center justify-center pt-32 pb-20 px-4">
                <div className="success-content text-center max-w-lg mx-auto bg-white p-12 rounded-3xl shadow-sm">
                    ...
                    <p className="text-[#6C6763]/70 mb-4 text-lg">
                        {t('success.description')}
                    </p>

                    <div className="space-y-4">
                        <p className="text-sm text-[#6C6763]/50">
                            {t('success.orderId', { orderId: orderSn || orderId })}
                        </p>
